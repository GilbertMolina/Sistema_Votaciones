    ...
    <body onload="muestraReloj()">
        <div class="wrapMapa">
            ...
            <form id="votaciones" name="votaciones" action="votacion.php" method="post">
                ...
                <br />
                <a href="resultado.php?PK_IdVotacion=<?php echo $PK_IdVotacion; ?>"><button id="volverResultados" name="volverResultados" type="button"><img src="../images/atras.png" style="vertical-align: text-bottom; width: 22px; height: 22px;" alt="Volver"><span style="vertical-align: baseline"> &nbsp;Volver</span></button></a>
                <br />
                <br />
